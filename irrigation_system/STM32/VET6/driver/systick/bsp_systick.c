 ...
 * @note 组划分:
 * @note 组0:0位抢占优先级,4位响应优先级
 * @note 组1:1位抢占优先级,3位响应优先级
 * @note 组2:2位抢占优先级,2位响应优先级
 * @note 组3:3位抢占优先级,1位响应优先级
 * @note 组4:4位抢占优先级,0位响应优先级
 * @note NVIC_SubPriority和NVIC_PreemptionPriority的原则是,数值越小,越优先
 */
